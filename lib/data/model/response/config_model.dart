class ConfigModel {
  ...
  bool _cod;
  BaseUrls _baseUrls;
  List<LangModel> listangModelFirst;
String _brands_home_page,_latest_products ,_recommended_dealOfDay,_new_arrival,_best_selling,_show_offers,
  _top_rated,_home_categories;
...
String _border_color;
  ...
  ConfigModel(
      {int systemDefaultCurrency,
        ...
        String priColor,
        String secColors,
String font_color,String border_color,
        ...
        String show_offers,
        String brands_home_page,String latest_products ,String recommended_dealOfDay,String new_arrival,String best_selling,
        String top_rated,String home_categories,
    ...
    this.listangModelFirst = liststatus;
    this._brands_home_page=brands_home_page;
    this._latest_products=latest_products;
    this._show_offers=show_offers;
    this._recommended_dealOfDay=recommended_dealOfDay;
    this._new_arrival=new_arrival;
    this._best_selling=best_selling;
    this._top_rated=top_rated;
    this._home_categories=home_categories;


    this._aboutUs = aboutUs;
    this._privacyPolicy = privacyPolicy;
    this._faq = faq;
    this._primayColors = priColor;
    this._secColors=secColors;
...
this._border_color=border_color;
  ...
  String get brands_home_page => _brands_home_page;
  String get latest_products => _latest_products;
  String get show_offers =>_show_offers;
  String get recommended_dealOfDay => _recommended_dealOfDay;
  String get new_arrival => _new_arrival;
  String get best_selling => _best_selling;
  String get top_rated => _top_rated;
  String get home_categories => _home_categories;
  ...
  String get primayColorsGet => _primayColors;
  String get secColorsGet => _secColors;
  String get font_color => _font_color;
String get border_color=>_border_color;
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
   ...
   if (json['faq'] != null) {
    ...
    _primayColors = json['theme_colors']['primary'];
    _secColors = json['theme_colors']['secondary'];
    _font_color = json['font_color']['font_color'];
_border_color = json['border_color']['border_color'];
    _brands_home_page = json['brands_home_page'].toString();
    _latest_products = json['latest_products'].toString();

    _show_offers = json['show-offers'].toString();

    _recommended_dealOfDay = json['recommended_dealOfDay'].toString();
    _new_arrival = json['new_arrival'].toString();
    _best_selling = json['best_selling'].toString();
    _top_rated = json['top_rated'].toString();
    _home_categories = json['home_categories'].toString();


    _termsConditions = json['terms_&_conditions'];
    if (json['currency_list'] != null) {
      _currencyList = [];
      json['currency_list'].forEach((v) {if(v['status']==1){
    ...
    if (json['language'] != null) {
      listangModelFirst = [];
      json['language'][0]['status'].forEach((v) {
        listangModelFirst.add(new LangModel.fromJson(v));
  ...
  Map<String, dynamic> toJson() {
    ...
    data['brands_home_page'] = this._brands_home_page;
    data['latest_products'] = this._latest_products;
    data['show-offers']= this._show_offers;
    data['recommended_dealOfDay'] = this._recommended_dealOfDay;
    data['new_arrival'] = this._new_arrival;
    data['best_selling'] = this._best_selling;
    data['top_rated'] = this._top_rated;
    data['home_categories'] = this._home_categories;
    ...
    data['primayColors'] = this._primayColors;
    data['secColors']=this._secColors;
data['font_color']=this._font_color;
data['border_color']=this._border_color;
...
class LangModel {
  ...
  bool get GetDefaultLang => defaultLang;
...
class BaseUrls {
  ...
  String _company_mobile_logo_url;
  ...
  BaseUrls(
      {String productImageUrl,
        ...
        String company_mobile_logo_url,
    ...
    this._company_mobile_logo_url = company_mobile_logo_url;
  ...
  String get CompanyMobileLogoUrl => _company_mobile_logo_url;
  ...
  BaseUrls.fromJson(Map<String, dynamic> json) {
    ...
    _company_mobile_logo_url = json['company_mobile_logo_url'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['company_mobile_logo_url'] = this._company_mobile_logo_url;
