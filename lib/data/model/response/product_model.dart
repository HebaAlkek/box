...
class sizeMode{
  ...
  String color;
  String size;
  sizeMode(this.id,this.color,this.size);
}
class Product {
  int _id;
  int _qty_status;
String _product_size;
  ...
  Product(
    ...
    this._wholesale_price=wholesale_price;
    this._minQty = minQty;
    this._images = images;
  ...
  int get id => _id;
  double get wholesale_price => _wholesale_price;
  int get qty_status  => _qty_status;
  String get product_size =>_product_size;
  ...
  String get product_color =>_product_color;
  ...
  Product.fromJson(Map<String, dynamic> json) {
    ...
    _qty_status = json['qty_status'];
    _product_size = json['product_size']!=null?json['product_size']:'';
    _userId = json['user_id'];
    _name = json['name'];
    _discountvalue = json['discountvalue']==null?'0':json['discountvalue'].toString();
    _discounttype = json['discounttype'].toString();

    _product_color = json['product_color'];
    _slug = json['slug'];
    _wholesale_price = json['wholesale_price']==null?0.0:double.parse(json['wholesale_price'].toString());
  ...
  Map<String, dynamic> toJson() {
    ...
    data['qty_status']=this._qty_status;
    data['product_size']=this._product_size;
    data['user_id'] = this._userId;
    data['name'] = this._name;
    data['product_color']=this._product_color;
    data['slug'] = this._slug;
    data['wholesale_price']=this._wholesale_price;
