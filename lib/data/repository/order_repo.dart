...
class OrderRepo {
  ...
  Future<ApiResponse> placeOrder(String addressID, String couponCode, String billingAddressId, String orderNote,String userID) async {
    try {
      if(userID==''){
        ...
        final    response = await dioClient.get(AppConstants.ORDER_PLACE_URI+'?address_id=$addressID&coupon_code=$couponCode&billing_address_id=$billingAddressId&order_note=$orderNote&user_id=$userID');
