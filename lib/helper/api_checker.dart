...
class ApiChecker {
  static void checkApi(
      BuildContext context, ApiResponse apiResponse, String type) {
    if (apiResponse.error is! String &&
      ...
      print(_errorMessage);
      if(_errorMessage.toString()=='Not Found'){

      }else if(_errorMessage.toString()=='Receive timeout in connection with API server'){
