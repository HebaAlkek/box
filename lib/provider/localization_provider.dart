...
class LocalizationProvider extends ChangeNotifier {
  ...
  void setLanguage(Locale locale,BuildContext cont) {
    _locale = locale;
    _isLtr = _locale.languageCode != 'ar';
    Provider.of<SplashProvider>(cont, listen: false).countryCodei = locale.countryCode;
    Provider.of<SplashProvider>(cont, listen: false).langDefault = locale.languageCode;
