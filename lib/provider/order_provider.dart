...
class OrderProvider with ChangeNotifier {
  ...
  Future<void> placeOrder(BuildContext context,OrderPlaceModel orderPlaceModel, Function callback, List<CartModel> cartList, String addressID, String couponCode, String billingAddressId, String orderNote,String userId) async {
    _isLoading = true;
    notifyListeners();
    ...
    if(Provider.of<ProfileProvider>(context,
        ...
        .toString() ==
        'seller account'){
      apiResponse = await orderRepo.placeOrder(addressID, couponCode, billingAddressId, orderNote,userId);


    }else{
      apiResponse = await orderRepo.placeOrder(addressID, couponCode, billingAddressId, orderNote,'');
