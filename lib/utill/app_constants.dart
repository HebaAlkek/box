...
// static const String BASE_URL = 'https://test.smartboardsb.com';
  ...
  static const String BRANDS_URI_login = '/api/v1/customer/user-brands';

  static const String BRAND_PRODUCT_URI = '/api/v1/brands/products/';
  static const String CATEGORY_PRODUCT_URI = '/api/v1/categories/products?id=';
  static const String REGISTRATION_URI = '/api/v1/auth/register';
  static const String LOGIN_URI = '/api/v1/auth/login';
  static const String OFFER_LIST = '/api/v1/products/offers?limit=10&offset=';
  ...
  static const String CUSTOMER_URI_buisness = '/api/v1/customer/business-account-info';
  static const String REFRESH_DATA = 'http://18.133.209.188:89/api/Box/GetGetBalanceForBusinessCustomer?code=';

  static const String BRANCH_QTY = '/api/Box/GetQtyInBranches';

  static const String ADDRESS_LIST_URI = '/api/v1/customer/address/list';
  static const String REMOVE_ADDRESS_URI = '/api/v1/customer/address?address_id=';
  static const String ADD_ADDRESS_URI = '/api/v1/customer/address/add';
  static const String ADD_BALA = '/api/v1/customer/update-balance';
  ...
  static const String GET_BUISNESS_USERS = '/api/v1/customer/buss';
  static const String GET_LIMIT_AMOUNT= '/api/v1/get-limit-amount?id=';
