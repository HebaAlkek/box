      ...
      return ListView(
        ...
        children: <Widget>[
          GestureDetector(
            ...
            child: ListTile(
              title: Text(getTranslated('nomatch', context)),
        ...
        return GestureDetector(
              ...
              setState(() {
                ...
                if (widget.getSelectedValue != null) {
                  widget.controller.text =
                      filteredList[i].f_name + ' ' + filteredList[i].l_name;
            ...
            child: ListTile(
                title: widget.getSelectedValue != null
                    ? Text(
                        filteredList[i].f_name + ' ' + filteredList[i].l_name)
                    : Text(filteredList[i].f_name +
                        ' ' +
                        filteredList[i].l_name)));
      },
      padding: EdgeInsets.zero,
      shrinkWrap: true,
    );
  ...
  Widget build(BuildContext context) {
    return CompositedTransformTarget(
      ...
      child: TextField(
        ...
        cursorColor: Color(int.parse('0xFF' +
