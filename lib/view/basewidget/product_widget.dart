                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                      productModel.discountvalue != null && int.parse(productModel.discountvalue) > 0
                          ? !isGuestMode
                                      ...
                                      style: titleRegular.copyWith(
                                        color: Color(int.parse('0xFF' +
                                            Provider.of<SplashProvider>(context, listen: false)
                                                .configModel
                                                .font_color
                                                .split('#')[1])),                                        decoration: TextDecoration.lineThrough,
                                        fontSize:
                                            Dimensions.FONT_SIZE_EXTRA_SMALL,
                                      ),
                                    )
                      ...
                      !isGuestMode
                          ? Provider.of<ProfileProvider>(context, listen: false)
                              ...
                              ? Text(
                                  PriceConverter.convertPrice(
                                      context, productModel.wholesale_price,
                                      discountType: productModel.discounttype,
                                      discount:double.parse(productModel.discountvalue)),
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(      boxShadow: [BoxShadow(color:Color(int.parse('0xFF' +
                        Provider.of<SplashProvider>(context, listen: false)
                            .configModel
                            .border_color
                            .split('#')[1])), spreadRadius: 0, blurRadius: 5)],
                    ...
                    child: Center(
                      child: productModel.discounttype=='percent'?Text(
                        getTranslated("DISCOUNTt", context)+' '+  productModel.discountvalue+' % ',
                                  style: robotoRegular.copyWith(
                                      color: Color(int.parse('0xFF' +
                                          Provider.of<SplashProvider>(context, listen: false)
                                              .configModel
                      ...
                      Text(
                          getTranslated("DISCOUNTt", context) +' ' +productModel.discountvalue+' '+  Provider.of<SplashProvider>(context, listen: false)
                            .myCurrency.symbol,
                        style: robotoRegular.copyWith(
                            color: Color(int.parse('0xFF' +
                                Provider.of<SplashProvider>(context, listen: false)
