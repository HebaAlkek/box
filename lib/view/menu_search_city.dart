...
class DropDownCity {
  ...
  final List<cityModelList> dataList;
  ...
  final Function(cityModelList) selectedItem;
...
class DropDownStateCity {
  DropDownCity dropDown;
  DropDownStateCity(this.dropDown);
...
class MainBody extends StatefulWidget {
  ...
  MainBody({ this.dropDown, Key key}) : super(key: key);
                  ...
                  Visibility(
                    ...
                    child: Align(
                      ...
                      child: ElevatedButton(
                          onPressed: () {
                            List<cityModelList> selectedList = widget
                                .dropDown.dataList
                      ...
                      child: Padding(
                        ...
                        child: ListTile(
                          ...
                          trailing: widget.dropDown.enableMultipleSelection
                            ...
                            onTap: () {
                              setState(() {
                                mainList[index].select =
                                !mainList[index].select;
                              });
                            },
                            child: mainList[index].select
