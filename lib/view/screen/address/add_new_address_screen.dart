...
import 'package:flutter_sixvalley_ecommerce/data/model/body/country_model.dart';
...
import 'package:flutter_sixvalley_ecommerce/data/repository/authRepository.dart';
import 'package:flutter_sixvalley_ecommerce/localization/language_constrants.dart';
import 'package:flutter_sixvalley_ecommerce/menu_search.dart';
...
import 'package:flutter_sixvalley_ecommerce/view/menu_search_city.dart';
...
class _AddNewAddressScreenState extends State<AddNewAddressScreen> {
  ...
  Address _address;
  List<countModelList> counList = <countModelList>[];
  countModelList counItem;

  List<cityModelList> cityList = <cityModelList>[];
  cityModelList cityItem;
  TextEditingController _searchTextEditingController = TextEditingController();
  TextEditingController _searchTextEditingControllercity =
      TextEditingController();
  ...
  getCountry() async {
    ...
    CountryResponse res = await _repository.getCountryList();
    print(res);

    if (res.code.toString() == '200') {
      setState(() {
        counList.addAll(res.data);
        loadCountry = true;
      });
    } else {
      setState(() {
  ...
  getCity(String countyCode) async {
    final CountryRepository _repository = CountryRepository();
    FormData data = FormData.fromMap({'country_code': countyCode});
    CityResponse res = await _repository.getCityList(data);
    print(res);

    if (res.code.toString() == '200') {
      setState(() {
        cityList.addAll(res.data);
      });
    } else {
      setState(() {});
    }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: InkWell(
          ...
          child: Icon(Icons.arrow_back_ios, color: Color(int.parse('0xFF' +
              Provider.of<SplashProvider>(context, listen: false)
                  .configModel
                  .font_color
                  .split('#')[1]))),
                                                ...
                                                DropDownStateCity(
                                                  DropDownCity(
                                                    ...
                                                    enableMultipleSelection:
                                                        false,
                                                    searchController:
                                                        _searchTextEditingControllercity,
                                                  ),
                                                ).showModal(context);
                                              },
                                              child: Container(
                                                      ...
                                                      Padding(
                                                          ...
                                                          child: new Container(
                                                            ...
                                                            child:
                                                              ...
                                                              new Spacer(),
                                                              Icon(Icons
                                                                  .arrow_drop_down_outlined,color: cityItem==null?Colors.grey:Colors.black,)
                                                            ]),
                                                          )),
                                                    ],
                                                  ),
                                ...
                                locationProvider.addressStatusMessage != null
                                    ...
                                    : Row(
                                        crossAxisAlignment:
                                            CrossAxisAlignment.start,
                                        children: [
                                          locationProvider.errorMessage.length >
                                                  0
                                              ? CircleAvatar(
                                                  backgroundColor:
                                                      Theme.of(context)
