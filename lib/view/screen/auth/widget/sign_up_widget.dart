  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        // for skip for now
      widget.home=='1'?Visibility(child: Text(''),visible: false,):  Provider.of<AuthProvider>(context).isLoading
            ? SizedBox()
            : Center(
              ...
              children: [
                TextButton(
                  ...
                  child: Text(getTranslated('SKIP_FOR_NOW', context),
                      style: titilliumRegular.copyWith(fontSize: Dimensions.FONT_SIZE_DEFAULT, color: Color(int.parse('0xFF' +
