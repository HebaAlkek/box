  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(getTranslated('all_brand', context), style: titilliumRegular.copyWith(fontSize: 20, color:   Color(int.parse('0xFF' +
            Provider.of<SplashProvider>(context, listen: false)
                .configModel
                .font_color
                .split('#')[1])))),
        actions: [
            ...
            return [
             ...
             /* CheckedPopupMenuItem(
              ...
              CheckedPopupMenuItem(
                ...
                child: Text(getTranslated('alphabetically_az', context), style: titilliumSemiBold.copyWith(fontSize: 11)),
              ),
              CheckedPopupMenuItem(
                value: 1,
                checked: Provider.of<BrandProvider>(context, listen: false).isZA,
                child: Text(getTranslated('alphabetically_za', context), style: titilliumSemiBold.copyWith(fontSize: 11)),
              ),
            ];
          },
          ...
          child: Padding(
            ...
            child: Image.asset(Images.filter_image, color:   Color(int.parse('0xFF' +
                Provider.of<SplashProvider>(context, listen: false)
                    .configModel
                    .font_color
                    .split('#')[1]))),
