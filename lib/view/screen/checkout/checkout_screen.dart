...
class CheckoutScreen extends StatefulWidget {
  ...
  CheckoutScreen(
      {@required this.cartList, this.fromProductDetails = false, @required this.discount, @required this.tax, @required this.totalOrderAmount, @required this.shippingFee, this.sellerId, this.buinessId});
                ...
                if (Provider
                  ...
                  if (Provider
                    ...
                    if (_cod && Provider
                      ...
                      String billId = _billingAddress ? Provider
                          .of<ProfileProvider>(context, listen: false)
                          .billingAddressList[Provider
                          .of<OrderProvider>(context, listen: false)
                          .billingAddressIndex].id.toString() :
                        ...
                        InkWell(
                          onTap: () async {
                            if (Provider
                              ...
                              if (Provider
                                ...
                                String orderNote = _orderNoteController.text
                                    .trim();
                                double couponDiscount = Provider
                                    .of<CouponProvider>(context, listen: false)
                                    .discount != null ? Provider
                                ...
                                if (_cod && Provider
                                  ...
                                  String userID = await Provider.of<
                                      ProfileProvider>(
                                      context, listen: false).getUserInfo(
                                      context);
                                  String addIs = Provider
                                      .of<OrderProvider>(context, listen: false)
                                      .addressIndex == null ? '' : Provider
                          ...
                          child: Provider
                            ...
                            decoration: BoxDecoration(
                              color: ColorResources.getPrimary(context),
                              boxShadow: [
                                BoxShadow(color: Color(int.parse('0xFF' +
                                    Provider
                                        .of<SplashProvider>(
                                        context, listen: false)
                                        .configModel
                  ...
                  builder: (context, order, child) {
                    return Container(
                      ...
                      child: CircularProgressIndicator(
                          valueColor: AlwaysStoppedAnimation<Color>( Color(int.parse('0xFF' +
                              Provider
                                  .of<SplashProvider>(
                                  context, listen: false)
                                  .configModel
      ...
      body: Column(
        children: [
          ...
          Provider
              ...
              .user_role
              .toString() !=
              'normal' ? CustomAppBar(title: getTranslated('Apply', context)) :
            ...
            child: ListView(physics: BouncingScrollPhysics(),
                ...
                children: [
                  ...
                  Provider
                      ...
                      .userInfoModel
                      .user_role
                      .toString() != 'normal' ? Visibility(
                    child: Text(''), visible: false,) : Consumer<OrderProvider>(
                          ...
                          child: SizedBox(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.only(
                                  ...
                                  bottom: 5),
                              child: Center(
                                child: TextField(controller: _controller,      cursorColor: Color(int.parse('0xFF' +
