            ...
            return Provider.of<ProfileProvider>(context, listen: false)
                ...
                ? Provider.of<ProfileProvider>(context, listen: false)
                    ...
                    ? Container(
                        width: _width,
                        height: _width * 0.3,
                        child: bannerProvider.mainBannerListB != null
                            ? bannerProvider.mainBannerListB.length != 0
                                ? Stack(
                                    fit: StackFit.expand,
                                    children: [
                                              ...
                                              child: ClipRRect(
                                                ...
                                                child: FadeInImage.assetNetwork(
                                                  ...
                                                  image:
                                                      ...
                                                      '/${bannerProvider.mainBannerListB[index].photo}',
                                                  imageErrorBuilder:
                                                      (c, o, s) => Image.asset(
                                                          Images
                                                              .placeholder_3x1,
                            ...
                            : Shimmer.fromColors(
                                ...
                                enabled: bannerProvider.mainBannerListB == null,
                                child: Container(
                                    margin:
                    ...
                    : Container(
                        width: _width,
                        height: _width * 0.3,
                        child: bannerProvider.mainBannerListN != null
                            ? bannerProvider.mainBannerListN.length != 0
                                ? Stack(
                                    fit: StackFit.expand,
                                    children: [
                                      CarouselSlider.builder(
                                            ...
                                            child: Container(
                                              ...
                                              child: ClipRRect(
                                                ...
                                                child: FadeInImage.assetNetwork(
                                                  ...
                                                  image:
                                                      '${Provider.of<SplashProvider>(context, listen: false).baseUrls.bannerImageUrl}'
                                                      '/${bannerProvider.mainBannerListN[index].photo}',
                                                  imageErrorBuilder:
                                                      (c, o, s) => Image.asset(
                                                          Images
                                                              .placeholder_3x1,
                            ...
                            : Shimmer.fromColors(
                                baseColor: Colors.grey[300],
                                highlightColor: Colors.grey[100],
                                enabled: bannerProvider.mainBannerListN == null,
                                child: Container(
                                    margin:
                                        EdgeInsets.symmetric(horizontal: 10),
                                    decoration: BoxDecoration(
                                ...
                                children: [
                                  CarouselSlider.builder(
                                    ...
                                    itemCount: bannerProvider
                                            ...
                                            0
                                        ? 1
                                        : bannerProvider.mainBannerListN.length,
                                    itemBuilder: (context, index, _) {
                                      return InkWell(
                                        onTap: () {
                                          Provider.of<BannerProvider>(context,
                                  ...
                                  Positioned(
                                    ...
                                    child: Row(
                                      mainAxisAlignment:
                                          MainAxisAlignment.center,
                                      children: bannerProvider.mainBannerListN
                                          .map((banner) {
                                        int index = bannerProvider
                                            .mainBannerListN
                                            .indexOf(banner);
