      ...
      builder: (context, featuredDealProvider, child) {
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            return         featuredDealProvider.featuredDealProductList[index]==null?Visibility(child: Text(''),visible: false,): InkWell(
              onTap: () {
              ...
              child: Container(
                ...
                child: Stack(children: [
                  Row(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                    ...
                    featuredDealProvider.featuredDealProductList[index]==null?Visibility(child: Text(''),visible: false,):  Expanded(
                      flex: 3,
                      child: Container(
                        decoration: BoxDecoration(
...
SizedBox(height: 15,),
                            ...
                            Row(crossAxisAlignment: CrossAxisAlignment.end,
                                children: [
                                  ...
                                  Text(
                                    int.parse(featuredDealProvider.featuredDealProductList[index].discountvalue) > 0 ?
                                    PriceConverter.convertPrice(context, featuredDealProvider.featuredDealProductList[index].wholesale_price.toDouble()) : '',
                                    style: robotoRegular.copyWith(
                                    ...
                                    int.parse(featuredDealProvider.featuredDealProductList[index].discountvalue) > 0 ? PriceConverter.convertPrice(context, featuredDealProvider.featuredDealProductList[index].unitPrice.toDouble()) : '',
                                    style: robotoRegular.copyWith(
                                      color: ColorResources.getRed(context),
                                      decoration: TextDecoration.lineThrough,
                                      fontSize: Dimensions.FONT_SIZE_SMALL,
                                ...
                                style: robotoRegular.copyWith(
                                  ...
                                  int.parse(featuredDealProvider.featuredDealProductList[index].discountvalue) > 0? SizedBox(width: Dimensions.PADDING_SIZE_DEFAULT): SizedBox(),
                                  !isGuestMode?
                                  Provider.of<ProfileProvider>(context, listen: false).userInfoModel.user_role.toString()=='business account' ?
                                  Text(
                                    PriceConverter.convertPrice(context, featuredDealProvider.featuredDealProductList[index].wholesale_price.toDouble(),
                                        discountType: featuredDealProvider.featuredDealProductList[index].discounttype, discount:int.parse( featuredDealProvider.featuredDealProductList[index].discountvalue).toDouble()),
                  ...
                  // Off
                  int.parse(featuredDealProvider.featuredDealProductList[index].discountvalue) > 0 ? Positioned(
                    top: 0,
                    left: 0,
                    child: Container(
                      ...
                      Text(
                        PriceConverter.percentageCalculation(
                          context,
                          featuredDealProvider.featuredDealProductList[index].wholesale_price.toDouble(),
                          int.parse(featuredDealProvider.featuredDealProductList[index].discountvalue).toDouble(),
