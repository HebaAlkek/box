                      ...
                      return InkWell(
                        ...
                        child: Container(
                          ...
                          child: Stack(children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(children: [
                                      ...
                                      Text(
                                        int.parse(megaProvider.flashDealList[index].discountvalue) > 0 ?
                                        PriceConverter.convertPrice(context, megaProvider.flashDealList[index].wholesale_price) : '',
                                      ...
                                      Text(
                                        PriceConverter.convertPrice(context, megaProvider.flashDealList[index].wholesale_price,
                                            discountType: megaProvider.flashDealList[index].discounttype, discount:double.parse( megaProvider.flashDealList[index].discountvalue)),
                            ...
                            // Off
                            int.parse(megaProvider.flashDealList[index].discountvalue) >= 1 ?
                            Positioned(
                              top: 0,
                              left: 0,
                              child: Container(
                                ...
                                Text(
                                  PriceConverter.percentageCalculation(
                                    context,
                                    megaProvider.flashDealList[index].wholesale_price,
                                 double.parse(   megaProvider.flashDealList[index].discountvalue),
            ...
            return InkWell(
              ...
              child: Container(
                ...
                child: Stack(children: [
                  ...
                  // Off
             int.parse(     megaProvider.flashDealList[index].discountvalue) >= 1 ? Positioned(
                    top: 0,
                    left: 0,
                    child: Container(
                      height: 20,
