              ...
              onTap: () {
                if (Provider.of<ProfileProvider>(context, listen: false)
                  ...
                  Provider.of<BannerProvider>(context, listen: false)
                      .getProductDetails(
                      context,
                      footerBannerProvider.mainBannerListB[index].resourceId
                          .toString());
                  _clickBannerRedirect(
                      context,
                      footerBannerProvider.mainBannerListB[index].resourceType ==
                          'product'
                          ? footerBannerProvider.mainBannerListB[index].product.id
                          : footerBannerProvider.mainBannerListB[index].resourceId,
                      footerBannerProvider.mainBannerListB[index].resourceType ==
                          'product'
                          ? footerBannerProvider.mainBannerListB[index].product
                          : null,
                      footerBannerProvider.mainBannerListB[index].resourceType);
                  ...
                  Provider.of<BannerProvider>(context, listen: false)
                      .getProductDetails(
                      context,
                      footerBannerProvider.mainBannerListN[index].resourceId
                          .toString());
                  _clickBannerRedirect(
                      context,
                      footerBannerProvider.mainBannerListN[index].resourceType ==
                          'product'
                          ? footerBannerProvider.mainBannerListN[index].product.id
                          : footerBannerProvider.mainBannerListN[index].resourceId,
                      footerBannerProvider.mainBannerListN[index].resourceType ==
                          'product'
                          ? footerBannerProvider.mainBannerListN[index].product
                          : null,
                      footerBannerProvider.mainBannerListN[index].resourceType);
