...
import 'package:flutter_sixvalley_ecommerce/pdf_print.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          CustomAppBar(title: getTranslated('ORDER_DETAILS', context),type: '1',onActionPressed: () async {
        /*    Uint8List targetlUinit8List;
            Uint8List originalUnit8List;
            String  imgUrl = Provider.of<SplashProvider>(context, listen: false)
                .configModel.baseUrls.CompanyMobileLogoUrl;
print(imgUrl);
            ...
            final netImage = await Image.memory(targetlUinit8List);*/
         String lang=   Provider.of<SplashProvider>(context, listen: false)
                .langDefault
                .toString();
            final pdfFile = await PdfInvoiceApi.generate(
              ...
              Provider.of<ProfileProvider>(context,
                ...
                PriceConverter.convertPrice(
                    context, _order),
               fee,PriceConverter.convertPrice(
                context, _discount), PriceConverter.convertPrice(
                context, _tax),PriceConverter.convertPrice(
                context, double.parse(totalp))
               );
               ...
               fee=   PriceConverter.convertPrice(
                ...
                'seller account'? Row(
                                            ...
                                            Expanded(
                                                child: Text(
                                                    ...
                                                    style: titilliumRegular
                                                        .copyWith(
                                                            fontSize: Dimensions
                                                                .FONT_SIZE_SMALL,color: Color(int.parse('0xFF' +
                                                        Provider.of<SplashProvider>(
                                                            context,
                                                            listen: false)
                                                            .configModel
                                ...
                                Row(
                                    ...
                                    children: [
                                      Text(
                                          '${getTranslated('customern', context)} : ',
                                          style: titilliumRegular.copyWith(
                                              fontSize: Dimensions
                                                  .FONT_SIZE_DEFAULT)),
                                      Expanded(
