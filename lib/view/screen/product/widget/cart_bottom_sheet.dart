            ...
            builder: (context, details, child) {
              ...
              if (!isGuestMode) {
                if (Provider.of<ProfileProvider>(context, listen: false)
                        ...
                        .toString() ==
                    'business account') {
                  price = widget.product.wholesale_price;
                } else {
              ...
              double priceWithDiscount = PriceConverter.convertWithDiscount(
                  context,
                  price,
              double.parse(    widget.product.discountvalue),
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        Row(
                          children: [
                            int.parse(widget.product.discountvalue) > 0
                                ? Container(
                                    ...
                                    ? Provider.of<ProfileProvider>(context,
                                        ...
                                        ? Text(
                                            PriceConverter.convertPrice(context,
                                                widget.product.wholesale_price),
                                            style: titilliumRegular.copyWith(
                                ...
                                ? Provider.of<ProfileProvider>(context,
                                    ...
                                    ? Text(
                                        PriceConverter.convertPrice(context,
                                            ...
                                            discountType:
                                                widget.product.discounttype,
                                            discount: double.parse(widget.product.discountvalue)),
                                        style: titilliumRegular.copyWith(
                                            color:   Color(int.parse('0xFF' +
                                                Provider.of<SplashProvider>(context, listen: false)
                                                    .configModel
                    ...
                    Row(
                      children: [
                        Provider.of<CartProvider>(context).isLoading
                            ...
                            : Expanded(
                                child: widget.product.qty_status == 0
                                    ? CustomButton(
    ...
    return IconButton(
      ...
      icon: Container(
        ...
        decoration: BoxDecoration(
            ...
            border:
                Border.all(width: 1, color:   Color(int.parse('0xFF' +
                    Provider.of<SplashProvider>(context, listen: false)
                        .configModel
                        .font_color
                        .split('#')[1])) )),
