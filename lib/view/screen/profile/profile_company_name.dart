...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  _updateUserAccount() async {
    ...
    if(Provider.of<ProfileProvider>(context, listen: false).userInfoModel.fName == _firstNameController.text
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(getTranslated('sixcpass', context)), backgroundColor: ColorResources.RED));
      ...
      await Provider.of<ProfileProvider>(context, listen: false).updateUserInfo(
        ...
        if(response.isSuccess) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(getTranslated('updates', context)), backgroundColor: Colors.green));
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  Row(
                                    children: [
                                      Icon(Icons.account_balance, color: ColorResources.getLightSkyBlue(context), size: 20),
                                      SizedBox(width: Dimensions.MARGIN_SIZE_EXTRA_SMALL),
                                      Text(getTranslated('comna', context), style: titilliumRegular)
                                    ],
                                  ),
                                  SizedBox(height: Dimensions.MARGIN_SIZE_SMALL),
                                  CustomTextField(
                                    focusNode: _comFocus,
                                    hintText: profile.userInfoModelBuisness.company_name ?? "",
                                    nextNode: _vatFocus,
                                    controller: _comName,
                                    isPhoneNumber: false,
                                  ),
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  Row(
                                    children: [
                                      Icon(Icons.elevator_outlined, color: ColorResources.getLightSkyBlue(context), size: 20),
                                      SizedBox(width: Dimensions.MARGIN_SIZE_EXTRA_SMALL),
                                      Text(getTranslated('vatn', context), style: titilliumRegular)
                                    ],
                                  ),
                                  SizedBox(height: Dimensions.MARGIN_SIZE_SMALL),
                                  CustomTextField(
                                    focusNode: _vatFocus,
                                    hintText: profile.userInfoModelBuisness.vat_number ?? "",
                                    nextNode: _comnFoucs,
                                    controller: _vatNum,
                                    isPhoneNumber: false,
                                  ),
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  Row(
                                    children: [
                                      Icon(Icons.category_outlined, color: ColorResources.getLightSkyBlue(context), size: 20),
                                      SizedBox(width: Dimensions.MARGIN_SIZE_EXTRA_SMALL),
                                      Text(getTranslated('comn', context), style: titilliumRegular)
                                    ],
                                  ),
                                  SizedBox(height: Dimensions.MARGIN_SIZE_SMALL),
                                  CustomTextField(
                                    focusNode: _comnFoucs,
                                    hintText: profile.userInfoModelBuisness.commerical_number ?? "",
