        ...
        Expanded(child: ListView(
          ...
          children: [
            ...
            TitleButton(
              ...
              onTap: () => showAnimatedDialog(context, CurrencyDialog(isCurrency: false,con: context,)),
            ),
            TitleButton(
              image: Images.currency,
              title: '${getTranslated('currency', context)} (${Provider.of<SplashProvider>(context).myCurrency.name})',
              onTap: () => showAnimatedDialog(context, CurrencyDialog(con: context,)),
            ),
            /*TitleButton(
...
class TitleButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      leading: Image.asset(image, width: 25, height: 25, fit: BoxFit.fill, color:  Color(int.parse('0xFF' +
