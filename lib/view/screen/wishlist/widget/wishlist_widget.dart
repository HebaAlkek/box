                ...
                children: [
                  ...
                  Stack(
                    children: [
                      ...
                      product.wholesale_price!=null && int.parse(product.discountvalue)>0?
                      Positioned(top: 0,left: 0,
                        child: Container(
                          ...
                          child: Text(product.wholesale_price!=null && product.discountvalue != null && product.discounttype != null?
                          PriceConverter.percentageCalculation(context, product.wholesale_price, double.parse(product.discountvalue), product.discounttype) : '',
                            style: titilliumRegular.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL, color: Theme.of(context).cardColor),
                          ),
                        ),
                      ):SizedBox():
                      product.unitPrice!=null && int.parse(product.discountvalue)>0?
                      Positioned(top: 0,left: 0,
                        child: Container(
                          height: 20,
                          padding: EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                          ...
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.only(topLeft: Radius.circular(Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                  bottomRight: Radius.circular(Dimensions.PADDING_SIZE_EXTRA_SMALL)),
                              color: Theme.of(context).primaryColor),
                          child: Text(product.unitPrice!=null && product.discountvalue != null && product.discounttype != null?
                          PriceConverter.percentageCalculation(context, product.unitPrice, double.parse(product.discountvalue), product.discounttype) : '',
                            style: titilliumRegular.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL, color: Theme.of(context).cardColor),
                          ),
                        ),
                      ):SizedBox():
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            product.discountvalue != null && int.parse(product.discountvalue)>0?
                            !isGuestMode?
                            Provider.of<ProfileProvider>(context, listen: false).userInfoModel.user_role.toString()=='business account' ?
                            Text(
                              product.wholesale_price != null?PriceConverter.convertPrice(context, product.wholesale_price):'',
                            ...
                            Text(
                              PriceConverter.convertPrice(context, product.wholesale_price, discount: double.parse(product.discountvalue),discountType:  product.discounttype),
                            ...
                            Text(
                              PriceConverter.convertPrice(context, product.unitPrice, discount: double.parse(product.discountvalue),discountType: product.discounttype),
                              maxLines: 1,overflow: TextOverflow.ellipsis,
                              style: titilliumRegular.copyWith(
                                  color: ColorResources.getPrimary(context),
                                  fontSize: Dimensions.FONT_SIZE_LARGE
